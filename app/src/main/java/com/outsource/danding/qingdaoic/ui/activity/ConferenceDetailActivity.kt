...
import kotlinx.android.synthetic.main.activity_conference_detail.*

class ConferenceDetailActivity : BaseActivity(), DatePickerFragment.OnDateSetListener {
...
//    var meetingTime:String?=null
    ...
    private fun initListener() {
        btn_commit_check.setOnClickListener {
            reSaveConferenceApply("1")
        }
        btn_update_save.setOnClickListener {
            reSaveConferenceApply("0")
        }
...
//        })
    ...
    private fun reSaveConferenceApply(flag: String) {1
        HttpClient.instance.reSaveConferenceApply(flag!!,expendType!!,applyDeptName!!, isLoan!!,
                ...
                .subscribe({
                    ...
                    if(data!=null&&data.get("result")!=null)
                    {
                        if(flag=="1"){
                            ...
                            {
                                Toast.makeText(this,"提交审核成功", Toast.LENGTH_SHORT).show()
                            }else{
                            ...
                            if(data.get("result").toString()=="1")
                            {
                                ...
                                Toast.makeText(this, "修改保存失败", Toast.LENGTH_SHORT).show()
                            }
                        }
