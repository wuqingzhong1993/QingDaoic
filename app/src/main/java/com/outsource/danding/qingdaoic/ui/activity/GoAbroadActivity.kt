...
import com.outsource.danding.qingdaoic.ui.fragment.GoAbroadApplyFragment
import com.outsource.danding.qingdaoic.widget.TabFragmentPagerAdapter
import com.trello.rxlifecycle2.kotlin.bindToLifecycle
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.schedulers.Schedulers
import kotlinx.android.synthetic.main.activity_go_abroad.*


class GoAbroadActivity : BaseActivity() {
    ...
    private fun initView() {
        title = "出国"
        fragments= mutableListOf(GoAbroadApplyFragment(), GoAbroadApplyFragment())
