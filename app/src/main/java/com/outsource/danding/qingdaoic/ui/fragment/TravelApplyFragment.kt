...
import com.outsource.danding.qingdaoic.ui.activity.TravelDetailActivity
import com.trello.rxlifecycle2.kotlin.bindToLifecycle
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.schedulers.Schedulers
import kotlinx.android.synthetic.main.item_list_travel.view.*

class TravelApplyFragment : BaseListFragment<BusinessInfo>() {
    ...
    override fun getView(parent: ViewGroup?, viewType: Int): View = layoutInflater.inflate(R.layout.item_list_travel, parent, false)
    ...
    {
        HttpClient.instance.getshenQingInfoList("10",mPage+1)
