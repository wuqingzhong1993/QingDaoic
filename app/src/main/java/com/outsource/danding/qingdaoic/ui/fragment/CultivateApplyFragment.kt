...
import kotlinx.android.synthetic.main.item_list_cultivate.view.*


class CultivateApplyFragment : BaseListFragment<BusinessInfo>() {
    ...
    {
        HttpClient.instance.getshenQingInfoList("14",mPage+1)
