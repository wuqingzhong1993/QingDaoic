...
import com.outsource.danding.qingdaoic.ui.fragment.JdApplyFragment
...
class JdActivity : BaseActivity() {
    ...
    private fun initView() {
        ...
        fragments= mutableListOf(JdApplyFragment(), JdApplyFragment())
